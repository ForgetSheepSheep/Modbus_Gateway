...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LED2_Pin|LED3_Pin|BEEP2_Pin
                          |BEEP1_Pin|RELAY1_Pin|RELAY1B5_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin LED2_Pin LED3_Pin BEEP2_Pin
                           BEEP1_Pin RELAY1_Pin RELAY1B5_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|LED3_Pin|BEEP2_Pin
                          |BEEP1_Pin|RELAY1_Pin|RELAY1B5_Pin;
