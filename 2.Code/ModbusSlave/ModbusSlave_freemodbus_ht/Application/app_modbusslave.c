...
static MbRegisterInstance_t g_MbRegisterInstanceTable[] =
{
    ...
    {.property = R,     .address = 0x0005, .minValue = 0, .maxValue = 0, .ReadCb = ModbusGetAHT20Temp,  .WriteCb = NULL,},
    {.property = R,     .address = 0x0006, .minValue = 0, .maxValue = 0, .ReadCb = ModbusGetAHT20Humi,  .WriteCb = NULL,},
...
static void ModbusGetAHT20Temp(uint16_t *value) { *value = AHT20GetTemp(); }
static void ModbusGetAHT20Humi(uint16_t *value) { *value = AHT20GetHumi(); }
